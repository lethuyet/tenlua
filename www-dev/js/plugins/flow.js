...
(function(window, document, undefined) {'use strict';
  ...
  function Flow(opts) {
    // // thuyet temp add
    // // remember to replace:
    // // this.flowObj.thuyetGetChunkSize()
    // // to:
    // // this.flowObj.opts.chunkSize
    // this.thuyetGetChunkSize = function(){
    // 	var allowEmails = ['lethuyet@live.com', 'saritvn@gmail.com', 'huynhquocphong@gmail.com', 'tlsup1@yahoo.com', 'spkt06@gmail.com'];
    // 	// var allowEmails = ['lethuyet@live.com', 'saritvn@gmail.com', 'huynhquocphong@gmail.com', 'tlsup1@yahoo.com'];
    // 	var userEmail = jQuery('[ng-view]').scope().localStorage.AUTH_currentUser.email;
    // 	if(typeof userEmail != 'undefined'){
	   //  	var _index = allowEmails.indexOf(userEmail);
	   //  	if(_index > -1){
	   //  		return 1*1024*1024;
	   //  	}
    // 	}
    // 	// return this.flowObj.opts.chunkSize;
    // 	return this.opts.chunkSize;
    // };
    // // end thuyet temp add
  ...
  FlowChunk.prototype = {
    ...
    //   this.xhr.send(data);
    // },
    // Thuyet comment above and add below:
    send: function () {
      var preprocess = this.flowObj.opts.preprocess;
      if (typeof preprocess === 'function') {
        switch (this.preprocessState) {
      ...
      // reader.onload = function(e){
	     ...
	     //  self.xhr.sendAsBinary(e.target.result);
      // };
      // var data = this.prepareXhrRequest('POST', false, this.flowObj.opts.method, bytes);
    ...
    prepareXhrRequest: function(method, isTest, paramsMethod, blob) {
      ...
      // if (method === 'GET' || paramsMethod === 'octet') {
        ...
        // });
        // target = this.getTarget(target, params);
		  // Thuyet comments 4 lines above to remove all params in the request.
        data = blob || null;
      // } else {
      //   // Add data from the query options
      //   data = new FormData();
