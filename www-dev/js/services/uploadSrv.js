...
.factory( 'uploadSrv', function( $rootScope, $http, $location, $routeParams, $timeout, uiState, dialog, authInterceptor, filesSrv, authSrv, searchSrv, API_URL, AUTH_EVENTS, AUTH_ANTILEAK, AUTH_ROLES ) {
	...
	$rootScope.$on(AUTH_EVENTS.logoutComplete, function() {
		_uploadSrv.removeAllFilesFromUploading();
	});
