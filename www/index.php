...
<!--[if lt IE 9]><script>location.href="update-browser.html"</script><![endif]-->
	...
	<link rel="stylesheet" href="css/6a83c6e5.tenlua.css">
...
<!-- <div class="alert-ad" type="warning" delay="2">
	<div id="LuckyRoundBanner" class="lucky-round clearfix text-align:center;">
		<a href="/lucky-round/" target="_blank" style="color:white">
			<img src="/lucky-round/images/vongquay.png" style="width: 70px; height: 70px; float:left; margin-right: 1em;">
			<h3 style="margin:0 0 .5em; text-align:center">"Quay cực nhanh, trúng cực đã!"</h3>
			<div style="text-align:center">
				<span class="btn btn-sm btn-default">Tham gia ngay</span>
			</div>
		</a>
	</div>
</div> -->
...
<script src="js/2e97dffc.tenlua.js"></script>
